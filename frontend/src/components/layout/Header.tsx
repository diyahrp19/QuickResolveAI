...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 px-3 pt-3 md:px-6 md:pt-4">
      <div className="relative h-16 rounded-2xl border border-border/80 bg-card/72 shadow-soft backdrop-blur-xl surface-ring">
        <div className="pointer-events-none absolute inset-x-10 top-0 h-px bg-linear-to-r from-transparent via-white/65 to-transparent" />
        <div className="h-full px-4 md:px-6 flex items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            >
              ...
              <span className="absolute top-2.5 right-2.5 h-2 w-2 rounded-full bg-destructive shadow-[0_0_0_4px_color-mix(in_oklch,var(--color-background)_65%,transparent)] animate-pulse" />
            </button>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button
                    ...
                    className="group flex items-center gap-2 rounded-full border border-border/80 bg-card/72 pl-1 pr-2 py-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background hover-lift"
                  >
